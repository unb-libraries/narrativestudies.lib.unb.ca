...
module.exports = function (grunt) {
  ...
  grunt.registerTask('clean:all', ['clean:composer', 'clean:githooks', 'clean:node', 'clean:tmp_transfer', 'clean:theme', 'clean:local_scripts', 'shell:gitclean']);
  grunt.registerTask('clean:all-no-gitclean', ['clean:composer', 'clean:githooks', 'clean:node', 'clean:tmp_transfer', 'clean:theme', 'clean:local_scripts']);
  ...
  grunt.registerTask('setup', ['validationsetup', 'shell:install_local_scripts', 'theme-setup']);
